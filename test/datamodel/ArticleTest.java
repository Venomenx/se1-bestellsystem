...
public class ArticleTest {
	...
	public void test002_EmptyArgumentConstructor() {
		...
		assertEquals( a.getId(), "" );		// "==" - equivalent
	...
	public void test010_SetDescription() {
		...
		final String descr = "Super Toaster Model XRC-2484698";
		aToaster.setDescription( descr );
		assertEquals(aToaster.getDescription(), descr);
